...
class ProductDetail extends React.Component {
	...
	render() {
		...
		console.log(product.supplier_info);
			...
			<>
				...
				<div className="flex justify-center">
					{this.runCallback(() => {
						...
						for (var i = 0; i < 2; i++) {
							col.push(
								<div class="w-1/3 bg-white rounded-xl shadow-md overflow-hidden">
									<div class="md:flex">
										...
										<div class="p-8">
											...
											<p class="mt-2 text-gray-500">
												...
												tight bond between cats and humans.
											</p>
										</div>
									</div>
								</div>
...
export default connect(mapToStateToProps, { getProduct })(ProductDetail);
